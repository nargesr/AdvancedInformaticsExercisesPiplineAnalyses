...
for i in range(samples.shape[0]):
	...
	src = path + "/*_R1_001.fastq.gz"
	dst = "/data/class/ecoevo283/nargesr/RNAseq/data/" + samples['sampleName'][i] + "_R1.fq.gz"
	os.symlink(src, dst)
	src = path + "/*_R2_001.fastq.gz"
	dst = "/data/class/ecoevo283/nargesr/RNAseq/data/" + samples['sampleName'][i] + "_R2.fq.gz"
	os.symlink(src, dst)
